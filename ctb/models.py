...
class activityRange(models.Model):
    ...
    # 维度
    latitude = models.FloatField(max_digits=20,decimal_places=3)
    # 经度
    longitude = models.FloatField(max_digits=20,decimal_places=3)
    createTime = models.BigIntegerField(default=0)
...
class doTask(models.Model):
    ...
    adImgs = models.CharField(max_length=1024)
    # 维度(可以为空)
    latitude = models.FloatField(max_digits=20,decimal_places=3,default=0.0)
    # 经度(可以为空)
    longitude = models.FloatField(max_digits=20,decimal_places=3,default=0.0)
