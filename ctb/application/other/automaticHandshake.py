        ...
        if dictIP['province'] == None or dictIP['province'] == "XX" :
            return Comm.callBackSuccess(callBackDict, 1,
                                        {"timeLen": projectInfoObj.manualreleaseTime, "auroraTag": "deflais",
                                         "tokenURP": projectInfoObj.skipUrl,"butUrl":projectInfoObj.butUrl,"img":projectInfoObj.imgUrl,"frame":projectInfoObj.configFrame,"configAciton":"itms-services://?action=download-manifest&amp;url="+projectInfoObj.configUrl})
        else:
            try:
